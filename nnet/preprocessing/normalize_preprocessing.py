...
def preprocess_for_train(record, output_height, output_width, add_image_summaries=False):
...
def preprocess_for_eval(record, output_height, output_width):
    return preprocess_for_train(record, output_height, output_width)


def preprocess(image, output_height, output_width, training=True, add_image_summaries=False):
    if training:
        return preprocess_for_train(image, output_height, output_width, add_image_summaries)
    else:
